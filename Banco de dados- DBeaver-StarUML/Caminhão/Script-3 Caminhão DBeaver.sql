...
--Utilizado UPPER para buscar por argumento em maiúsculas também, 
--senão só buscará maiusculo ou minusculo dependendo se colocou B ou b
select * from motorista m 
where upper(m.nomemotorista) like '%B%';
--ou use o comando ~~* este busca a letra não importando se for maiuscula ou minuscula
