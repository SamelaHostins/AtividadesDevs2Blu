	...
	public static void main(String[] args) {
		 /**
		    ...
		    */
		    ...
		    double valorInvestido, rendimentoMensal;
		       ...
		       System.out.println("Informe o tipo da conta: (Exemplo: Corrente");  
		        tipoDaConta=ler.next();
		      
		       System.out.println("Informe o tipo de investimento sendo: Poupança = 1, Poupança plus = 2 ou "
		       		+ "Fundos de renda = 3 ");  
		        tipoDoInvestimento=ler.nextInt();

		        if(tipoDoInvestimento == 1){
		            descricao = "Poupanca";
		            rendimentoMensal = (valorInvestido * 1.015f) - valorInvestido;
		            System.out.println(" A conta " + tipoDaConta + ", do codigo " + codigo 
		             + " fez um investimento tipo: " + descricao + ", que rendeu R$" + rendimentoMensal+
		             " totalizando R$"+ (rendimentoMensal+valorInvestido));
		            
		        }else if(tipoDoInvestimento == 2){
		            descricao = "Poupança plus";
		            rendimentoMensal = (valorInvestido * 1.02f) - valorInvestido;
		            System.out.println(" A conta " + tipoDaConta + ", do codigo " + codigo 
				             + " fez um investimento tipo: " + descricao + ", que rendeu R$" + rendimentoMensal+
				             " totalizando R$"+ (rendimentoMensal+valorInvestido));
		            ...
		            rendimentoMensal = (valorInvestido * 1.04) - valorInvestido;
		            System.out.println(" A conta " + tipoDaConta + ", do codigo " + codigo 
				             + " fez um investimento tipo: " + descricao + ", que rendeu R$" + rendimentoMensal+
				             " totalizando R$"+ (rendimentoMensal+valorInvestido));
		        }
